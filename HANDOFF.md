...
Last updated: **2026-04-26** by Sebastian (Codex). Latest changes: attempted AIR-024/025 code-review bugfix pass on `work` branch; blocked because this checkout only contains docs (no `src/` scaffold).
